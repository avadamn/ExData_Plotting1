...
plot(x=data$DateEff, y=data$Voltage, type="l", xlab="datetime", 
       ylab="Voltage")
plot(x=data$DateEff, y=data$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering")
lines(x=data$DateEff,data$Sub_metering_2, col="red", type="l")
lines(x=data$DateEff,data$Sub_metering_3, col="blue", type="l")

## to add legend
legend("topright", col=c("black", "red", "blue"), lty=1, lwd=2, 
                   legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),bty="n")
plot(x=data$DateEff, y=data$Global_reactive_power, type="l", xlab="datetime", 
